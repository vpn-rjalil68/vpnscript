...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} WireGuard sudah diinstal, sila ketik addwg untuk menambah client."
	exit 1
fi
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/vpn-rjalil68/vpnscript/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/vpn-rjalil68/vpnscript/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/vpn-rjalil68/vpnscript/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/vpn-rjalil68/vpnscript/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
